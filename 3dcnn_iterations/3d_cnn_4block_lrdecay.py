# 4 conv blocks: Conv3d -> ReLU -> MaxPool3d(2), channels 1->8->16->32->64, ~77K params.
# Manual SGD with inverse-frequency loss weights; LR halved every 15 epochs.
...
class CNN3D(nn.Module):
    ...
    def __init__(self):
        ...
        # 4th block halves spatial dims from 12 to 6, reducing FC input from 55296 to 13824.
...
def train_one_epoch(model, loader, learning_rate, class_weights):
    """One pass over the training set with manual SGD. Returns (mean_loss, mean_acc)."""
    model.train()
...
def main():
    ...
    results_file = results_dir / f"4block_lrdecay_{timestamp}.csv"
    ...
    for epoch in range(1, epochs + 1):
        ...
        train_loss, train_acc       = train_one_epoch(model, train_loader, current_lr, class_weights)
