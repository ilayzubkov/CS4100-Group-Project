...
def main():
    ...
    results_file = results_dir / f"checkpoint_{timestamp}.csv"
    ...
    for epoch in range(1, epochs + 1):
        ...
        if val_loss < best_val_loss:
            ...
            best_epoch       = epoch
            # clone() is required — without it we store references that get overwritten
        ...
        epoch_rows.append({
            ...
            "checkpoint": "best" if val_loss == best_val_loss else "",
        })

    print(f"\nBest val loss {best_val_loss:.4f} at epoch {best_epoch} — restoring for test.")
    ...
    fieldnames = [
        ...
        "val_loss", "val_acc", "val_c0", "val_c1", "val_c2", "checkpoint",
